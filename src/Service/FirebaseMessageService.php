...
class FirebaseMessageService extends FirebaseServiceBase {
  ...
  /**
   * Condition pattern for sending message to multiple topics. Supported
   * operators: &&, ||. Maximum two operators per topic message supported.
  ...
  /**
   * Add single device or group of devices or multiple devices to message target.
   *
